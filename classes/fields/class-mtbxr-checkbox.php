...
if(!class_exists('Mtbxr_Checkbox')):
	
	if(MTBXR_DEBUG){
		$mtbxr_debug_info[] = 'Included class Mtbxr_Checkbox in '.__FILE__;
	}
	
	class Mtbxr_Checkbox extends Mtbxr_Field{
		...
		public function render_main_view($meta, $post_id, $field_class=''){
			$saved_value = ( isset($meta[ $this->definition['uid'] ]) ) ? $meta[$this->definition['uid']] : '0';
