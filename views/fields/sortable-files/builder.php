...
<div class="mtbxr-admin-box">
	<div class="mtbxr-admin-header">
		<span class="mtbxr-admin-title"><?php _e('Sortable Files', 'mtbxr'); ?></span>
	...
	<div class="mtbxr-admin-body">
		...
		<input type="hidden" name="mtbxr[fields][<?php echo $index; ?>][type]" value="sortable_files" class="update-my-index" />
