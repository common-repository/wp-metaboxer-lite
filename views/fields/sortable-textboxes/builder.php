...
<div class="mtbxr-admin-box">
	<div class="mtbxr-admin-header">
		<span class="mtbxr-admin-title"><?php _e('Sortable Textboxes', 'mtbxr'); ?></span>
	...
	<div class="mtbxr-admin-body">
		...
		<input type="hidden" value="sortable_textboxes" class="update-my-index" name="mtbxr[fields][<?php echo $index; ?>][type]" />
		...
		<div class="mtbxr-admin-more-content">			
			...
			<label for="mtbxr-sanitation-<?php echo $index; ?>" class="update-my-index"><?php _e('Sanitation', 'mtbxr'); ?></label>
			<select id="mtbxr-sanitation-<?php echo $index; ?>" class="update-my-index" name="mtbxr[fields][<?php echo $index; ?>][sanitation]">
				<option <?php echo ($sanitation=='html') ? 'selected="selected"' : ''; ?> value="html"><?php _e('Allow HTML', 'mtbxr'); ?></option>
				<option <?php echo ($sanitation=='nohtml') ? 'selected="selected"' : ''; ?> value="nohtml"><?php _e('No HTML', 'mtbxr'); ?></option>
				<option <?php echo ($sanitation=='raw') ? 'selected="selected"' : ''; ?> value="raw"><?php _e('Raw', 'mtbxr'); ?></option>
			</select>
