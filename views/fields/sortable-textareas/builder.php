...
<div class="mtbxr-admin-box">
	<div class="mtbxr-admin-header">
		<span class="mtbxr-admin-title"><?php _e('Sortable Textareas', 'mtbxr'); ?></span>
	...
	<div class="mtbxr-admin-body">
		...
		<input type="hidden" value="sortable_textareas" class="update-my-index" name="mtbxr[fields][<?php echo $index; ?>][type]" />
