...
<div class="mtbxr-admin-box" data-index="<?php echo $index; ?>">
	<div class="mtbxr-admin-header">
		<span class="mtbxr-admin-title"><?php _e('Checkbox Group', 'mtbxr'); ?></span>
	...
	<div class="mtbxr-admin-body">
		...
		<input type="hidden" name="mtbxr[fields][<?php echo $index; ?>][type]" value="checkbox_group" class="update-my-index" />
		...
		<label for="" class="mtbxr-options-table"><?php _e('Checkboxes', 'mtbxr'); ?></label> 
		<table class="mtbxr-options-table">
			...
			<tr class="row">
				...
				<td><a href="#" class="mtbxr-option-delete">Delete</a></td>
			</tr>
			<?php } ?>
		</table>
